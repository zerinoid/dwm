...
static char *fonts[]                    = { "monospace:size=9.5", "NotoColorEmoji:pixelsize=10:antialias=true:autohint=true" };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_Escape,     spawn,          SHCMD("randomwal") },
	{ MODKEY,                       XK_semicolon,  spawn,          { .v = (const char*[]){ "dmenuunicode", NULL } } },
	...
	{ MODKEY,                       XK_minus,      spawn,          SHCMD("pulsemixer --change-volume -3; kill -44 $(pidof dwmblocks)") },
	{ MODKEY|ShiftMask,             XK_minus,      spawn,          SHCMD("pulsemixer --change-volume -9; kill -44 $(pidof dwmblocks)") },
	{ MODKEY,                       XK_equal,      spawn,          SHCMD("pulsemixer --change-volume +3; pulsemixer --unmute; kill -44 $(pidof dwmblocks)") },
	{ MODKEY|ShiftMask,             XK_equal,      spawn,          SHCMD("pulsemixer --change-volume +9; pulsemixer --unmute; kill -44 $(pidof dwmblocks)") },
	...
	{ MODKEY|ShiftMask,             XK_e,          spawn,          SHCMD("emacsclient -s $EMACS_SERVER_SOCKET -c -n -e \"(my/insert-todo-at-top)\"") },
	{ MODKEY,                       XK_r,          spawn,          { .v = (const char*[]){ TERMINAL, "-e", "lf", NULL } } },
	{ MODKEY|ShiftMask,             XK_r,          spawn,          { .v = (const char*[]){ TERMINAL, "-e", "btm", "--mem_as_value", NULL } } },
	...
	{ MODKEY|ControlMask,           XK_s,          spawn,          SHCMD("sleep 0.5 && slock systemctl suspend -i") },
	{ MODKEY,                       XK_d,          spawn,          { .v = (const char*[]){ "dmenu_run", NULL } } },
	{ MODKEY|ControlMask,           XK_d,          spawn,          { .v = (const char*[]){ "rofi", "-no-lazy-grab", "-show", "drun", "-theme", "/home/zerinol/.config/rofi/rofi.rasi", NULL } } },
	{ MODKEY|ShiftMask,             XK_d,          spawn,          { .v = (const char*[]){ "maimtemp", NULL } } },
	...
	{ MODKEY|ShiftMask,             XK_m,          spawn,          SHCMD("amixer -D pulse set Master 1+ toggle; kill -44 $(pidof dwmblocks)") },
	...
	{ MODKEY,                       XK_F11,        spawn,          SHCMD("demacs") },
	...
	{ 0,                            XF86XK_AudioRaiseVolume,  spawn,   SHCMD("pulsemixer --change-volume +3; pulsemixer --unmute; kill -44 $(pidof dwmblocks)") },
	{ 0,                            XF86XK_AudioLowerVolume,  spawn,   SHCMD("pulsemixer --change-volume -3; kill -44 $(pidof dwmblocks)") },
